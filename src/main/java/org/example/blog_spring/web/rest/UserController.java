...
public class UserController {
        ...
        public ResponseEntity<ApiResponse<UserDto>> createUser(
                ...
                var response = ApiResponse.success(HttpStatus.CREATED, "User created successfully",
                                userDto);
        ...
        public ResponseEntity<ApiResponse<UserDto>> getUser(@PathVariable Long id) {
                ...
                var response = ApiResponse.success(HttpStatus.OK, "User retrieved successfully",
                                userDto);
        ...
        public ResponseEntity<ApiResponse<Page<UserDto>>> getUsers(Pageable pageable) {
                ...
                var response = ApiResponse.success(HttpStatus.OK, "Users retrieved successfully",
                                users);
                return ResponseEntity.ok(response);
        }
        ...
        public ResponseEntity<ApiResponse<UserDto>> updateUser(@PathVariable Long id,
                ...
                var response = ApiResponse.success(HttpStatus.OK, "User updated successfully",
                                updated);
                return ResponseEntity.ok(response);
        }
        ...
        public ResponseEntity<ApiResponse<Void>> deleteUser(@PathVariable Long id) {
                ...
                var response = ApiResponse.<Void>success(HttpStatus.NO_CONTENT,
